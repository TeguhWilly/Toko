                ...
                <div class="row">
                    <div class="col-md-4 clearfix">
                        <div class="logo pull-left">
                            <a href="/BahanStudy/index.html"><img src="/BahanStudy/images/home/logo.png" alt="" /></a>
                        </div>
                    ...
                    <div class="col-md-8 clearfix">
                        <div class="shop-menu clearfix pull-right">
                            <ul class="nav navbar-nav">
                                <li><a href="/BahanStudy/checkout.html"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                <li><a href="/BahanStudy/cart.html"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                                <li><a href="/BahanStudy/login.html"><i class="fa fa-lock"></i> Login</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
